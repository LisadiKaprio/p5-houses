...
class LayerOfHouses {
	...
	drawLayerOfHouses() {
		...
		translate(
			mapAsset(cameraPositionX, -cameraBoundsX, cameraBoundsX, -cameraBoundsX, cameraBoundsX)
			,0);
...
function draw() {
	...
	housesBack.layerScale = mapAsset(mouseY, window.innerHeight, 0, 0.8, 1.2);
	housesBack.layerOnY = mapAsset(mouseY, (window.innerHeight * 2), 0, -(window.innerHeight * 0.4), (window.innerHeight / 10));
	
	housesMiddle.layerScale = mapAsset(mouseY, window.innerHeight, 0, 0.8, 1.6);
	housesMiddle.layerOnY = mapAsset(mouseY, (window.innerHeight * 2), 0, -(window.innerHeight * 0.4), (window.innerHeight / 6));
	
	housesFront.layerScale = mapAsset(mouseY, window.innerHeight, 0, 0.8, 1.9);
	housesFront.layerOnY = mapAsset(mouseY, (window.innerHeight * 2), 0, -(window.innerHeight * 0.2), (window.innerHeight / 2));
